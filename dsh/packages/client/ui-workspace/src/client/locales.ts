...
export const zh = {
  ...
  'dbx.panel.title': '数据库',
  'dbx.openTab': '在新标签页打开',
  'dbx.hint': '若页面无法加载，请先在启动脚本中开启 DBX 服务。',
  'rename': '重命名',
...
export const en = {
  ...
  'dbx.panel.title': 'Database',
  'dbx.openTab': 'Open in new tab',
  'dbx.hint': 'If the page fails to load, start the DBX service first in the launch script.',
  'rename': 'Rename',
